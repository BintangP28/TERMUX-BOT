let handler  = async (m, { conn, usedPrefix: _p }) => {
  let preview = {}
  try {
    if (!conn.menu) preview = await conn.generateLinkPreview('https://github.com/BintangP28/TERMUX-BOT')
  } catch (e) {
    try {
...
╠➥ Github: https://github.com/BintangP28/TERMUX-BOT
║
╠═〘 Info Bot 〙 ═
╠➥ Name : TERMUX-BOT
